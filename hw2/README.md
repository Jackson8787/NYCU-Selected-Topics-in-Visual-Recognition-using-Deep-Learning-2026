...
data. Under the homework rule, only the ResNet-50 backbone uses pretrained
weights, while the DETR transformer and detection heads are trained from
scratch. The final system keeps the official DETR setting as the base, then
...
- post-processing experiments such as NMS and soft-NMS
...
- representative strong validation AP: `0.48975`

Representative strong configuration:
